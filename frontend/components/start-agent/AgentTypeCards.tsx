...
const agents = [
  {
    ...
    benefit: 'Earn passive $NEXUSCLAW with minimal gas cost',
    time: '~2 minutes',
    available: true,
  },
  {
    ...
    description: 'Posts on Moltbook and Telegram. Earns rewards per approved post.',
    benefit: 'Grow the community while earning $NEXUSCLAW',
    time: '~5 minutes',
    available: true,
  },
  {
    ...
    benefit: 'Full autonomy — define your own earning strategy',
    time: 'Advanced',
    available: false,
  },
];
