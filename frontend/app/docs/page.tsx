    ...
    <div className="min-h-screen bg-[#131313] text-[#e5e2e1]">
      ...
      <main className="pt-24 pb-16 px-8 max-w-[1440px] mx-auto">
        <div className="border-l-4 border-[#abc7ff] pl-6 py-2 mb-12 mt-8">
          <h1 className="text-4xl md:text-5xl font-['Space_Grotesk'] font-black tracking-tighter uppercase leading-none mb-2">DOCS</h1>
          <p className="font-['JetBrains_Mono'] text-xs uppercase tracking-[0.2em] text-[#8b919f]">Developer Documentation // Protocol Reference</p>
        </div>
        <div className="flex flex-col items-center justify-center py-32 text-center">
          ...
          <p className="font-['JetBrains_Mono'] text-xs text-[#414754] mt-4 max-w-sm">Smart contract references, agent SDK docs, and integration guides for the NexusClaw protocol.</p>
