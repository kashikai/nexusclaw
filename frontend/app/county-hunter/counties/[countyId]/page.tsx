        ...
        <div className="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(0,380px)]">
          ...
          <Card className="min-w-0">
            ...
            <form onSubmit={addSource} className="mt-4 min-w-0 space-y-4 [&_input]:min-w-0 [&_select]:min-w-0">
              ...
              <Field label="Type"><Select className="w-full" value={sourceForm.source_type} onChange={(e) => setSourceForm({ ...sourceForm, source_type: e.target.value })}><option value="tax_sale">Tax sale</option><option value="assessor">Assessor</option><option value="gis">GIS</option><option value="clerk">Clerk</option><option value="legal_newspaper">Legal newspaper</option><option value="other">Other</option></Select></Field>
